...
getLibDir = catchIO (getEnv "etna_lib_libdir") (\_ -> return libdir)
getDynLibDir = catchIO (getEnv "etna_lib_dynlibdir") (\_ -> return dynlibdir)
getDataDir = catchIO (getEnv "etna_lib_datadir") (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "etna_lib_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "etna_lib_sysconfdir") (\_ -> return sysconfdir)

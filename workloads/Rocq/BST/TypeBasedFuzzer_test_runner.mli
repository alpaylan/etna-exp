...
val genPairSized : 'a1 genSized -> 'a2 genSized -> ('a1 * 'a2) genSized
...
val test_prop_InsertPost : (((tree0 * int) * int) * int) -> bool option
...
val test_prop_InsertDelete : (((tree0 * int) * int) * int) -> bool option

val test_prop_InsertDelete_fuzzer : unit -> result

val test_prop_InsertUnion : (((tree0 * tree0) * int) * int) -> bool option

val test_prop_InsertUnion_fuzzer : unit -> result

val test_prop_DeleteInsert : (((tree0 * int) * int) * int) -> bool option

...
let test_prop_InsertValid =
  forAll testChecker showTree (genOfGenSized genSizedTree) (fun t0 ->
...
let test_prop_UnionValid =
  forAll testChecker showTree (genOfGenSized genSizedTree) (fun t1 ->
    forAll (checkable_opt testBool) showTree (genOfGenSized genSizedTree)
      (fun t2 -> prop_UnionValid t1 t2))
...
let test_prop_UnionPost =
  forAll testChecker showTree (genOfGenSized genSizedTree) (fun t0 ->
    forAll testChecker showTree (genOfGenSized genSizedTree) (fun t' ->
      forAll (checkable_opt testBool) showNat (genOfGenSized genNatSized)
...
let test_prop_DeleteDelete =
  forAllShrink testChecker showTree (genOfGenSized genSizedTree) shrinkTree
    (fun t0 ->
    forAllShrink testChecker showNat (genOfGenSized genNatSized) shrinkNat
      (fun k ->
      forAllShrink testChecker showNat (genOfGenSized genNatSized) shrinkNat
        (fun k' ->
            ...
            (showPair
              (showPair
                (showPair (showPair (showPair showTree showNat) showNat)
                  showTree) showTree) showTree) showTree ((((((t0, k), k'),
            (delete k t0)), (delete k' t0)), (delete k (delete k' t0))),

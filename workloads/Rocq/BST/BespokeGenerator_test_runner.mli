     ...
     sig
      ...
      module L :
       sig
        ...
        type 'elt coq_R_mem =
        | R_mem_0 of 'elt t
        | R_mem_1 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_mem_2 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_mem_3 of 'elt t * char list * 'elt * (char list * 'elt) list
           * bool * 'elt coq_R_mem

        val coq_R_mem_rect :
          key -> ('a1 t -> __ -> 'a2) -> ('a1 t -> char list -> 'a1 ->
          (char list * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t ->
          char list -> 'a1 -> (char list * 'a1) list -> __ -> __ -> __ ->
          'a2) -> ('a1 t -> char list -> 'a1 -> (char list * 'a1) list -> __
        ...
        type 'elt coq_R_find =
        | R_find_0 of 'elt t
        | R_find_1 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_find_2 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_find_3 of 'elt t * char list * 'elt * (char list * 'elt) list
           * 'elt option * 'elt coq_R_find
        ...
        type 'elt coq_R_add =
        | R_add_0 of 'elt t
        | R_add_1 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_add_2 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_add_3 of 'elt t * char list * 'elt * (char list * 'elt) list
           * 'elt t * 'elt coq_R_add

        val coq_R_add_rect :
          key -> 'a1 -> ('a1 t -> __ -> 'a2) -> ('a1 t -> char list -> 'a1 ->
          (char list * 'a1) list -> __ -> __ -> __ -> 'a2) -> ('a1 t ->
          char list -> 'a1 -> (char list * 'a1) list -> __ -> __ -> __ ->
          'a2) -> ('a1 t -> char list -> 'a1 -> (char list * 'a1) list -> __
        ...
        type 'elt coq_R_remove =
        | R_remove_0 of 'elt t
        | R_remove_1 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_remove_2 of 'elt t * char list * 'elt * (char list * 'elt) list
        | R_remove_3 of 'elt t * char list * 'elt * (char list * 'elt) list
        ...
        type ('elt, 'a) coq_R_fold =
        | R_fold_0 of 'elt t * 'a
        | R_fold_1 of 'elt t * 'a * char list * 'elt
           * (char list * 'elt) list * 'a * ('elt, 'a) coq_R_fold

        val coq_R_fold_rect :
          (key -> 'a1 -> 'a2 -> 'a2) -> ('a1 t -> 'a2 -> __ -> 'a3) -> ('a1 t
          -> 'a2 -> char list -> 'a1 -> (char list * 'a1) list -> __ -> 'a2
        ...
        val fold_rect :
          (key -> 'a1 -> 'a2 -> 'a2) -> ('a1 t -> 'a2 -> __ -> 'a3) -> ('a1 t
          -> 'a2 -> char list -> 'a1 -> (char list * 'a1) list -> __ -> 'a3
          -> 'a3) -> 'a1 t -> 'a2 -> 'a3
        ...
        type 'elt coq_R_equal =
        | R_equal_0 of 'elt t * 'elt t
        | R_equal_1 of 'elt t * 'elt t * char list * 'elt
           * (char list * 'elt) list * char list * 'elt
           * (char list * 'elt) list * bool * 'elt coq_R_equal
        | R_equal_2 of 'elt t * 'elt t * char list * 'elt
           * (char list * 'elt) list * char list * 'elt
           * (char list * 'elt) list * char list compare0
        | R_equal_3 of 'elt t * 'elt t * 'elt t * 'elt t

        val coq_R_equal_rect :
          ('a1 -> 'a1 -> bool) -> ('a1 t -> 'a1 t -> __ -> __ -> 'a2) -> ('a1
          t -> 'a1 t -> char list -> 'a1 -> (char list * 'a1) list -> __ ->
          char list -> 'a1 -> (char list * 'a1) list -> __ -> __ -> __ ->
          bool -> 'a1 coq_R_equal -> 'a2 -> 'a2) -> ('a1 t -> 'a1 t ->
          char list -> 'a1 -> (char list * 'a1) list -> __ -> char list ->
          'a1 -> (char list * 'a1) list -> __ -> char list compare0 -> __ ->
          __ -> 'a2) -> ('a1 t -> 'a1 t -> 'a1 t -> __ -> 'a1 t -> __ -> __
          -> 'a2) -> 'a1 t -> 'a1 t -> bool -> 'a1 coq_R_equal -> 'a2
        ...
        val equal_rect :
          ('a1 -> 'a1 -> bool) -> ('a1 t -> 'a1 t -> __ -> __ -> 'a2) -> ('a1
          t -> 'a1 t -> char list -> 'a1 -> (char list * 'a1) list -> __ ->
          char list -> 'a1 -> (char list * 'a1) list -> __ -> __ -> __ -> 'a2
          -> 'a2) -> ('a1 t -> 'a1 t -> char list -> 'a1 -> (char list * 'a1)
          list -> __ -> char list -> 'a1 -> (char list * 'a1) list -> __ ->
          char list compare0 -> __ -> __ -> 'a2) -> ('a1 t -> 'a1 t -> 'a1 t
...
val props' :
  'a1 checkable -> int -> ('a2 -> 'a1) -> ('a2 -> 'a2 list) -> 'a2 -> checker
  rose
...
val l_unionBy :
  (int -> int -> int) -> (int * int) list -> (int * int) list -> (int * int)
  list
...
val prop_InsertInsert : tree0 -> int -> int -> int -> int -> bool option
...
val prop_UnionDeleteInsert : tree0 -> tree0 -> int -> int -> bool option

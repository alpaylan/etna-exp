    ...
    freq_ (returnGen E) (((Stdlib.Int.succ 0),
      ...
      (thunkGen (fun _ ->
        bindGen (genSizedTree size') (fun p0 ->
          bindGen (genOfGenSized genNatSized) (fun p1 ->
            bindGen (genOfGenSized genNatSized) (fun p2 ->
...
| E ->
  bindGen (genOfGenSized genSizedTree) (fun param0 ->
    bindGen (genOfGenSized genNatSized) (fun param1 ->
      bindGen (genOfGenSized genNatSized) (fun param2 ->
        bindGen (genOfGenSized genSizedTree) (fun param3 ->
    ...
    ((thunkGen (fun _ ->
       bindGen (fuzzyTree p3) (fun fuzzed ->
         returnGen (T (p0, p1, p2, fuzzed))))) :: ((thunkGen (fun _ ->
                                                     returnGen p3)) :: (
    (thunkGen (fun _ ->
      bindGen (fuzzyNat p2) (fun fuzzed -> returnGen (T (p0, p1, fuzzed, p3))))) :: (
    (thunkGen (fun _ ->
      bindGen (fuzzyNat p1) (fun fuzzed -> returnGen (T (p0, fuzzed, p2, p3))))) :: (
    (thunkGen (fun _ ->
...
let test_prop_InsertValid_fuzzer _ =
  fuzzLoopWith
    ...
    (fuzzyProd (fuzzyProd fuzzyTree fuzzyNat) fuzzyNat)
    (showPair (showPair showTree showNat) showNat) test_prop_InsertValid
...
let test_prop_DeleteValid_fuzzer _ =
  fuzzLoopWith
    (updMaxDiscard (updMaxSuccess (updAnalysis stdArgs true) num_tests)
      num_tests) (genOfGenSized (genPairSized genSizedTree genNatSized))
    (fuzzyProd fuzzyTree fuzzyNat) (showPair showTree showNat)
...
let test_prop_UnionValid_fuzzer _ =
  fuzzLoopWith
    (updMaxDiscard (updMaxSuccess (updAnalysis stdArgs true) num_tests)
      num_tests) (genOfGenSized (genPairSized genSizedTree genSizedTree))
    (fuzzyProd fuzzyTree fuzzyTree) (showPair showTree showTree)
...
let test_prop_DeletePost_fuzzer _ =
  fuzzLoopWith
    ...
    (genOfGenSized
      (genPairSized (genPairSized genSizedTree genNatSized) genNatSized))
    (fuzzyProd (fuzzyProd fuzzyTree fuzzyNat) fuzzyNat)
    (showPair (showPair showTree showNat) showNat) test_prop_DeletePost
...
let test_prop_UnionPost_fuzzer _ =
  fuzzLoopWith
    ...
    (fuzzyProd (fuzzyProd fuzzyTree fuzzyTree) fuzzyNat)
    (showPair (showPair showTree showTree) showNat) test_prop_UnionPost
...
let test_prop_InsertModel_fuzzer _ =
  fuzzLoopWith
    ...
    (genOfGenSized
      (genPairSized (genPairSized genSizedTree genNatSized) genNatSized))
    (fuzzyProd (fuzzyProd fuzzyTree fuzzyNat) fuzzyNat)
    (showPair (showPair showTree showNat) showNat) test_prop_InsertModel
  ...
  fuzzLoopWith
    ...
    (genOfGenSized
      (genPairSized
        (genPairSized (genPairSized genSizedTree genSizedTree) genNatSized)
        genNatSized))
    (fuzzyProd (fuzzyProd (fuzzyProd fuzzyTree fuzzyTree) fuzzyNat) fuzzyNat)
    (showPair (showPair (showPair showTree showTree) showNat) showNat)
...
let test_prop_DeleteDelete_fuzzer _ =
  fuzzLoopWith
    ...
    (genOfGenSized
      (genPairSized (genPairSized genSizedTree genNatSized) genNatSized))
    (fuzzyProd (fuzzyProd fuzzyTree fuzzyNat) fuzzyNat)
    (showPair (showPair showTree showNat) showNat) test_prop_DeleteDelete
...
let test_prop_DeleteUnion_fuzzer _ =
  fuzzLoopWith
    ...
    (genOfGenSized
      (genPairSized (genPairSized genSizedTree genSizedTree) genNatSized))
    (fuzzyProd (fuzzyProd fuzzyTree fuzzyTree) fuzzyNat)
    (showPair (showPair showTree showTree) showNat) test_prop_DeleteUnion
...
let test_prop_UnionUnionIdem_fuzzer _ =
  fuzzLoopWith
    (updMaxDiscard (updMaxSuccess (updAnalysis stdArgs true) num_tests)
      num_tests) (genOfGenSized genSizedTree) fuzzyTree showTree
...
let qctest_test_prop_UnionValid _ =
  print_extracted_coq_string
    (append ('['::('|'::('{'::[])))
      (append
        (showTimedResult showResult (withTime test_prop_UnionValid_fuzzer))
        ('}'::('|'::(']'::[])))))
...
let qctest_test_prop_UnionPost _ =
  print_extracted_coq_string
    (append ('['::('|'::('{'::[])))
      (append
        (showTimedResult showResult (withTime test_prop_UnionPost_fuzzer))
        ('}'::('|'::(']'::[])))))
...
let qctest_test_prop_UnionModel _ =
  print_extracted_coq_string
    (append ('['::('|'::('{'::[])))
      (append
        (showTimedResult showResult (withTime test_prop_UnionModel_fuzzer))
        ('}'::('|'::(']'::[])))))
...
let qctest_test_prop_InsertUnion _ =
  print_extracted_coq_string
    (append ('['::('|'::('{'::[])))
      (append
        (showTimedResult showResult (withTime test_prop_InsertUnion_fuzzer))
        ('}'::('|'::(']'::[])))))
...
let qctest_test_prop_DeleteUnion _ =
  print_extracted_coq_string
    (append ('['::('|'::('{'::[])))
      (append
        (showTimedResult showResult (withTime test_prop_DeleteUnion_fuzzer))
        ('}'::('|'::(']'::[])))))
